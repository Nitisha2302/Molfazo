{{--
  Product share deep link landing page.
  Shared URLs: https://mudir.inbozor.app/product/{id}
  Opens inBozor via inbozor://product/{id}, else App Store / Play Store.
--}}
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <title>inBozor — Open Product</title>
...
<body>
  <div class="card">
    ...
    <h1>Open in inBozor</h1>
    <p id="status">Opening the product in the app…</p>
  ...
  <script>
    window.__PRODUCT_ID__ = @json((string) $id);
    ...
    (function () {
      ...
      var productId = String(window.__PRODUCT_ID__ || "");
      ...
      if (!/^\d+$/.test(productId)) {
        statusEl.textContent = "Install inBozor to browse products.";
