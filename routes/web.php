...
Route::group(['prefix' => 'dashboard', 'as' => 'dashboard.'], function () {
    ...
    ;
        ...
        Route::post('attribute-requests/{id}/reject', [AttributeRequestController::class,'reject'])
            ...
            Route::resource('packages', PromotionPackageController::class);
        Route::get('promotion-requests', [PromotionRequestController::class,'index'])->name('promotion.requests');
        Route::get('promotion-requests/{id}/approve', [PromotionRequestController::class,'approve'])->name('promotion.approve');

        Route::get('payment', [AdminPaymentController::class,'edit'])->name('payment.edit');
        Route::post('payment', [AdminPaymentController::class,'update'])->name('payment.update');

        Route::get('promotion-requests', [PromotionRequestController::class,'index'])
        ->name('promotion.requests');

        Route::get('promotion-requests/{id}/approve', [PromotionRequestController::class,'approve'])
            ->name('promotion.requests.approve');
